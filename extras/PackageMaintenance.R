...
OhdsiRTools::checkUsagePackage("PLEMSKAIalloutcomes")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/PLEMSKAIalloutcomes.pdf")
shell("R CMD Rd2pdf ./ --output=extras/PLEMSKAIalloutcomes.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "PLEMSKAIalloutcomes")
...
OhdsiRTools::createRenvLockFile("PLEMSKAIalloutcomes")
